    ...
    public partial class Polish : Form
    {
        ...
        private void Search()
        {
            ...
            Center.cmd.CommandText = $@"WITH PolishData AS
                                        ...
                                        CASE WHEN ISNULL(JobDetail.PriceJob, 0) > ISNULL(JobCost_DetailJob.JobPrice, 0) THEN 'ไม่ถูกต้อง' ELSE '' END AS CenterAcc,
                                        ...
                                        LEFT JOIN JobCost_DetailJob ON JobKeeps.JobBarcode = JobCost_DetailJob.JobBarcode AND JobDetail.LotNo = JobCost_DetailJob.Lotno
