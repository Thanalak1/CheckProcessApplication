    ...
    public partial class BatheAndPolish : Form
    {
        ...
        private void previewBtn_Click(object sender, EventArgs e)
        {
            ...
            Center.cmd.CommandText = $@"WITH RankedData AS
                                        ...
                                        CASE WHEN ISNULL(AccEmp2.AccPrice, 0) > ISNULL(JobCost.Center3, 0) + ISNULL(JobCost.Center5, 0) THEN 'ไม่ถูกต้อง' ELSE '' END AS CenterAcc,
                                        --สต. นน. DiffWgloss
